        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-3 p-0" id="menu">
                ...
                <div class="nav flex-column nav-pills btn-tabs-box" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link p-0" id="v-pills-payments-tab" data-toggle="pill" href="#v-pills-payments" role="tab" aria-controls="v-pills-payments" aria-selected="false">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="row">
                                        ...
                                        <div class="col-3 p-0">
                                            <a href="houses.php" class="btn btn-custom">View</a>
                                        </div>
                                    </div>
                                </div>

                                <div class="col-md-4 pb-1">
                                    <a href="./apartments.php" class="btn btn-custom" id="to-house-form">Add House</a>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <div class="row">
                                        ...
                                        <div class="col-3"><?php echo $tenant_count ?></div>
                                        <div class="col-3">
